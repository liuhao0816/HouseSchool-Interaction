...
public interface HealthyMapper extends BaseMapper<Healthy> {
    void queryByPublisherTime(@Param("userName") String userName, @Param("createTime") String createTime);
    List<Healthy> queryByPublisher01(@Param("userName") String userName, @Param("createTime") String createTime);
    List<Healthy> queryByHealthyDto01(@Param("firstDateTime")String firstDateTime, @Param("lastDateTime")String lastDateTime, @Param("studentName")String studentName, @Param("gradeClass")String gradeClass);
